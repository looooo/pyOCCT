...
PYBIND11_MODULE(Standard, mod) {
	...
	*/
	...
	// deprecated: cls_Standard_Failure.def_static("Caught_", (opencascade::handle<Standard_Failure> (*)()) &Standard_Failure::Caught, "Returns the last caught exception. Needed when exceptions are emulated by C longjumps, in other cases is also provided for compatibility.");
