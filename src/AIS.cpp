...
PYBIND11_MODULE(AIS, mod) {
	...
	// deprecated: cls_AIS_InteractiveContext.def("SetTransformPersistence", [](AIS_InteractiveContext &self, const opencascade::handle<AIS_InteractiveObject> & a0, const Graphic3d_TransModeFlags & a1) -> void { return self.SetTransformPersistence(a0, a1); }, py::arg("theObj"), py::arg("theFlag"));
	...
	// deprecated: cls_AIS_InteractiveContext.def("OpenLocalContext", [](AIS_InteractiveContext &self) -> Standard_Integer { return self.OpenLocalContext(); });
	// deprecated: cls_AIS_InteractiveContext.def("OpenLocalContext", [](AIS_InteractiveContext &self, const Standard_Boolean a0) -> Standard_Integer { return self.OpenLocalContext(a0); }, py::arg("UseDisplayedObjects"));
	// deprecated: cls_AIS_InteractiveContext.def("OpenLocalContext", [](AIS_InteractiveContext &self, const Standard_Boolean a0, const Standard_Boolean a1) -> Standard_Integer { return self.OpenLocalContext(a0, a1); }, py::arg("UseDisplayedObjects"), py::arg("AllowShapeDecomposition"));
	// deprecated: cls_AIS_InteractiveContext.def("OpenLocalContext", [](AIS_InteractiveContext &self, const Standard_Boolean a0, const Standard_Boolean a1, const Standard_Boolean a2) -> Standard_Integer { return self.OpenLocalContext(a0, a1, a2); }, py::arg("UseDisplayedObjects"), py::arg("AllowShapeDecomposition"), py::arg("AcceptEraseOfObjects"));
	...
	// deprecated: cls_AIS_InteractiveContext.def("CloseLocalContext", [](AIS_InteractiveContext &self) -> void { return self.CloseLocalContext(); });
	// deprecated: cls_AIS_InteractiveContext.def("CloseLocalContext", [](AIS_InteractiveContext &self, const Standard_Integer a0) -> void { return self.CloseLocalContext(a0); }, py::arg("theIndex"));
	...
	// deprecated: cls_AIS_InteractiveContext.def("ClearLocalContext", [](AIS_InteractiveContext &self) -> void { return self.ClearLocalContext(); });
	...
	// deprecated: cls_AIS_InteractiveContext.def("KeepTemporary", [](AIS_InteractiveContext &self, const opencascade::handle<AIS_InteractiveObject> & a0) -> Standard_Boolean { return self.KeepTemporary(a0); }, py::arg("anIObj"));
