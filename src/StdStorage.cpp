...
PYBIND11_MODULE(StdStorage, mod) {
	...
	*/
	...
	//linux: not working cls_StdStorage_TypeData.def("Instantiator", (StdObjMgt_Persistent::Instantiator (StdStorage_TypeData::*)(const Standard_Integer) const ) &StdStorage_TypeData::Instantiator, "Returns a persistent object instantiator of <aTypeName>", py::arg("aTypeNum"));
