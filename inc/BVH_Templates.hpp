...
void bind_BVH_Box(py::object &mod, std::string const &name) {
	...
	cls.def(py::init<>());
// FIXME	cls.def(py::init<const BVH_Box<T, N>::BVH_VecNt &>(), py::arg("thePoint"));
	cls.def(py::init([] (const BVH_Box<T, N> &other) {return new BVH_Box<T, N>(other);}), "Copy constructor", py::arg("other"));
// FIXME	cls.def(py::init<const BVH_Box<T, N>::BVH_VecNt &, const BVH_Box<T, N>::BVH_VecNt &>(), py::arg("theMinPoint"), py::arg("theMaxPoint"));
...
// FIXME	cls.def("Add", (void (BVH_Box<T, N>::*)(const BVH_Box<T, N>::BVH_VecNt &)) &BVH_Box<T, N>::Add, "Appends new point to the bounding box.", py::arg("thePoint"));
...
// FIXME	cls.def("CornerMin", (const BVH_Box<T, N>::BVH_VecNt & (BVH_Box<T, N>::*)() const ) &BVH_Box<T, N>::CornerMin, "Returns minimum point of bounding box.");
// FIXME	cls.def("CornerMax", (const BVH_Box<T, N>::BVH_VecNt & (BVH_Box<T, N>::*)() const ) &BVH_Box<T, N>::CornerMax, "Returns maximum point of bounding box.");
// FIXME	cls.def("CornerMin", (BVH_Box<T, N>::BVH_VecNt & (BVH_Box<T, N>::*)()) &BVH_Box<T, N>::CornerMin, "Returns minimum point of bounding box.");
// FIXME	cls.def("CornerMax", (BVH_Box<T, N>::BVH_VecNt & (BVH_Box<T, N>::*)()) &BVH_Box<T, N>::CornerMax, "Returns maximum point of bounding box.");
...
// FIXME	cls.def("Size", (BVH_Box<T, N>::BVH_VecNt (BVH_Box<T, N>::*)() const ) &BVH_Box<T, N>::Size, "Returns diagonal of bounding box.");
// FIXME	cls.def("Center", (BVH_Box<T, N>::BVH_VecNt (BVH_Box<T, N>::*)() const ) &BVH_Box<T, N>::Center, "Returns center of bounding box.");
...
// FIXME	cls.def("Objects", (BVH_ObjectSet<T, N>::BVH_ObjectList & (BVH_ObjectSet<T, N>::*)()) &BVH_ObjectSet<T, N>::Objects, "Returns reference to the array of geometric objects.");
// FIXME	cls.def("Objects", (const BVH_ObjectSet<T, N>::BVH_ObjectList & (BVH_ObjectSet<T, N>::*)() const ) &BVH_ObjectSet<T, N>::Objects, "Returns reference to the array of geometric objects.");
...
void bind_BVH_Transform(py::object &mod, std::string const &name) {
	...
	cls.def(py::init<>());
// FIXME	cls.def(py::init<const BVH_Transform<T, N>::BVH_MatNt &>(), py::arg("theTransform"));
// FIXME	cls.def("Transform", (const BVH_Transform<T, N>::BVH_MatNt & (BVH_Transform<T, N>::*)() const ) &BVH_Transform<T, N>::Transform, "Returns transformation matrix.");
...
// FIXME	cls.def("MinPoint", (BVH_TreeBase<T, N>::BVH_VecNt & (BVH_TreeBase<T, N>::*)(const int)) &BVH_TreeBase<T, N>::MinPoint, "Returns minimum point of the given node.", py::arg("theNodeIndex"));
// FIXME	cls.def("MaxPoint", (BVH_TreeBase<T, N>::BVH_VecNt & (BVH_TreeBase<T, N>::*)(const int)) &BVH_TreeBase<T, N>::MaxPoint, "Returns maximum point of the given node.", py::arg("theNodeIndex"));
// FIXME	cls.def("MinPoint", (const BVH_TreeBase<T, N>::BVH_VecNt & (BVH_TreeBase<T, N>::*)(const int) const ) &BVH_TreeBase<T, N>::MinPoint, "Returns minimum point of the given node.", py::arg("theNodeIndex"));
// FIXME	cls.def("MaxPoint", (const BVH_TreeBase<T, N>::BVH_VecNt & (BVH_TreeBase<T, N>::*)(const int) const ) &BVH_TreeBase<T, N>::MaxPoint, "Returns maximum point of the given node.", py::arg("theNodeIndex"));
