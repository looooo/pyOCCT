...
PYBIND11_MODULE(PrsMgr, mod) {
	...
	// deprecated cls_PrsMgr_PresentableObject.def("SetTransformPersistence", [](PrsMgr_PresentableObject &self, const Graphic3d_TransModeFlags a0) -> void { return self.SetTransformPersistence(a0); }, py::arg("theMode"));
