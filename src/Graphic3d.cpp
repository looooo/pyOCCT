...
PYBIND11_MODULE(Graphic3d, mod) {
	...
	// deprecated: cls_Graphic3d_AspectFillArea3d.def("Values", [](Graphic3d_AspectFillArea3d &self, Aspect_InteriorStyle & theStyle, Quantity_Color & theIntColor, Quantity_Color & theEdgeColor, Aspect_TypeOfLine & theType, Standard_Real & theWidth){ self.Values(theStyle, theIntColor, theEdgeColor, theType, theWidth); return theWidth; }, "Returns the current values.", py::arg("theStyle"), py::arg("theIntColor"), py::arg("theEdgeColor"), py::arg("theType"), py::arg("theWidth"));
	// deprecated: cls_Graphic3d_AspectFillArea3d.def("Values", [](Graphic3d_AspectFillArea3d &self, Aspect_InteriorStyle & theStyle, Quantity_Color & theIntColor, Quantity_Color & theBackIntColor, Quantity_Color & theEdgeColor, Aspect_TypeOfLine & theType, Standard_Real & theWidth){ self.Values(theStyle, theIntColor, theBackIntColor, theEdgeColor, theType, theWidth); return theWidth; }, "Returns the current values.", py::arg("theStyle"), py::arg("theIntColor"), py::arg("theBackIntColor"), py::arg("theEdgeColor"), py::arg("theType"), py::arg("theWidth"));
	...
	// deprecated: cls_Graphic3d_AspectLine3d.def("Values", [](Graphic3d_AspectLine3d &self, Quantity_Color & theColor, Aspect_TypeOfLine & theType, Standard_Real & theWidth){ self.Values(theColor, theType, theWidth); return theWidth; }, "Returns the current values of the group.", py::arg("theColor"), py::arg("theType"), py::arg("theWidth"));
	...
	// deprecated cls_Graphic3d_AspectMarker3d.def("Values", [](Graphic3d_AspectMarker3d &self, Quantity_Color & theColor, Aspect_TypeOfMarker & theType, Standard_Real & theScale){ self.Values(theColor, theType, theScale); return theScale; }, "Returns the current values of the group.", py::arg("theColor"), py::arg("theType"), py::arg("theScale"));
