...
PYBIND11_MODULE(V3d, mod) {
	...
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString>(), py::arg("theDriver"), py::arg("theName"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real, const V3d_TypeOfOrientation>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"), py::arg("theViewProj"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real, const V3d_TypeOfOrientation, const Quantity_Color &>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"), py::arg("theViewProj"), py::arg("theViewBackground"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real, const V3d_TypeOfOrientation, const Quantity_Color &, const V3d_TypeOfVisualization>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"), py::arg("theViewProj"), py::arg("theViewBackground"), py::arg("theVisualization"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real, const V3d_TypeOfOrientation, const Quantity_Color &, const V3d_TypeOfVisualization, const V3d_TypeOfShadingModel>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"), py::arg("theViewProj"), py::arg("theViewBackground"), py::arg("theVisualization"), py::arg("theShadingModel"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real, const V3d_TypeOfOrientation, const Quantity_Color &, const V3d_TypeOfVisualization, const V3d_TypeOfShadingModel, const Standard_Boolean>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"), py::arg("theViewProj"), py::arg("theViewBackground"), py::arg("theVisualization"), py::arg("theShadingModel"), py::arg("theComputedMode"));
	// deprecated cls_V3d_Viewer.def(py::init<const opencascade::handle<Graphic3d_GraphicDriver> &, const Standard_ExtString, const Standard_CString, const Standard_Real, const V3d_TypeOfOrientation, const Quantity_Color &, const V3d_TypeOfVisualization, const V3d_TypeOfShadingModel, const Standard_Boolean, const Standard_Boolean>(), py::arg("theDriver"), py::arg("theName"), py::arg("theDomain"), py::arg("theViewSize"), py::arg("theViewProj"), py::arg("theViewBackground"), py::arg("theVisualization"), py::arg("theShadingModel"), py::arg("theComputedMode"), py::arg("theDefaultComputedMode"));
	...
	// deprecated cls_V3d_Viewer.def("DefaultBackgroundColor", [](V3d_Viewer &self, const Quantity_TypeOfColor theType, Standard_Real & theV1, Standard_Real & theV2, Standard_Real & theV3){ self.DefaultBackgroundColor(theType, theV1, theV2, theV3); return std::tuple<Standard_Real &, Standard_Real &, Standard_Real &>(theV1, theV2, theV3); }, "None", py::arg("theType"), py::arg("theV1"), py::arg("theV2"), py::arg("theV3"));
	...
	//deprecrated cls_V3d_View.def("SetProj", (void (V3d_View::*)(const V3d_TypeOfOrientation)) &V3d_View::SetProj, "Defines the orientation of the projection .", py::arg("Orientation"));
	...
	// deprecated cls_V3d_View.def("Export", [](V3d_View &self, const Standard_CString a0, const Graphic3d_ExportFormat a1) -> Standard_Boolean { return self.Export(a0, a1); }, py::arg("theFileName"), py::arg("theFormat"));
