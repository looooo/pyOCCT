...
void bind_NCollection_EBTree(py::object &mod, std::string const &name) {
	...
	// warning: ISO C++ forbids declaration of ‘type name’ with no type [-fpermissive]
	// error: expected primary-expression before ‘const’
	//FIXME cls.def("FindNode", (const NCollection_EBTree<TheObjType, TheBndType>::TreeNode & (NCollection_EBTree<typename TheObjType, typename TheBndType>::*)(const TheObjType &) const ) &NCollection_EBTree<TheObjType, TheBndType>::FindNode, "Returns The leaf node containing the object.", py::arg("theObj"));
...
void bind_NCollection_List(py::object &mod, std::string const &name) {
	...
	//FIXME cls.def("Append", (void (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::Append, "Append one item at the end and output iterator pointing at the appended item", py::arg("theItem"), py::arg("theIter"));
	...
	//FIXME cls.def("Remove", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::Remove, "Remove item pointed by iterator theIter; theIter is then set to the next item", py::arg("theIter"));
	//FIXME cls.def("InsertBefore", (TheItemType & (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertBefore, "InsertBefore", py::arg("theItem"), py::arg("theIter"));
	//FIXME cls.def("InsertBefore", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertBefore, "InsertBefore", py::arg("theOther"), py::arg("theIter"));
	//FIXME cls.def("InsertAfter", (TheItemType & (NCollection_List<TheItemType>::*)(const TheItemType &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertAfter, "InsertAfter", py::arg("theItem"), py::arg("theIter"));
	//FIXME cls.def("InsertAfter", (void (NCollection_List<TheItemType>::*)(NCollection_List<TheItemType> &, NCollection_List<TheItemType>::Iterator &)) &NCollection_List<TheItemType>::InsertAfter, "InsertAfter", py::arg("theOther"), py::arg("theIter"));
...
void bind_NCollection_Map(py::object &mod, std::string const &name) {
	...
	// error: expected unqualified-id before ‘*’ token
	//FIXME cls.def("cbegin", (NCollection_Map<TheKeyType, Hasher>::const_iterator (NCollection_Map<TheKeyType, Hasher>::*)() const ) &NCollection_Map<TheKeyType, Hasher>::cbegin, "Returns a const iterator pointing to the first element in the map.");
	//FIXME cls.def("cend", (NCollection_Map<TheKeyType, Hasher>::const_iterator (NCollection_Map<TheKeyType, Hasher>::*)() const ) &NCollection_Map<TheKeyType, Hasher>::cend, "Returns a const iterator referring to the past-the-end element in the map.");
...
void bind_NCollection_Sequence(py::object &mod, std::string const &name) {
	...
	// error: cannot declare pointer to ‘void’ member
	//FIXME cls.def("Remove", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType>::Iterator &)) &NCollection_Sequence<TheItemType>::Remove, "Remove one item", py::arg("thePosition"));
	//FIXME cls.def("Remove", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer)) &NCollection_Sequence<TheItemType>::Remove, "Remove one item", py::arg("theIndex"));
	//FIXME cls.def("Remove", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, const Standard_Integer)) &NCollection_Sequence<TheItemType>::Remove, "Remove range of items", py::arg("theFromIndex"), py::arg("theToIndex"));
	//FIXME cls.def("Append", (void (NCollection_Sequence<TheItemType>::*)(const TheItemType &)) &NCollection_Sequence<TheItemType>::Append, "Append one item", py::arg("theItem"));
	//FIXME cls.def("Append", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType> &)) &NCollection_Sequence<TheItemType>::Append, "Append another sequence (making it empty)", py::arg("theSeq"));
	//FIXME cls.def("Prepend", (void (NCollection_Sequence<TheItemType>::*)(const TheItemType &)) &NCollection_Sequence<TheItemType>::Prepend, "Prepend one item", py::arg("theItem"));
	//FIXME cls.def("Prepend", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType> &)) &NCollection_Sequence<TheItemType>::Prepend, "Prepend another sequence (making it empty)", py::arg("theSeq"));
	//FIXME cls.def("InsertBefore", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, const TheItemType &)) &NCollection_Sequence<TheItemType>::InsertBefore, "InsertBefore theIndex theItem", py::arg("theIndex"), py::arg("theItem"));
	//FIXME cls.def("InsertBefore", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, NCollection_Sequence<TheItemType> &)) &NCollection_Sequence<TheItemType>::InsertBefore, "InsertBefore theIndex another sequence", py::arg("theIndex"), py::arg("theSeq"));
	//FIXME cls.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(NCollection_Sequence<TheItemType>::Iterator &, const TheItemType &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter the position of iterator", py::arg("thePosition"), py::arg("theItem"));
	//FIXME cls.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, NCollection_Sequence<TheItemType> &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter theIndex theItem", py::arg("theIndex"), py::arg("theSeq"));
	//FIXME cls.def("InsertAfter", (void (NCollection_Sequence<TheItemType>::*)(const Standard_Integer, const TheItemType &)) &NCollection_Sequence<TheItemType>::InsertAfter, "InsertAfter theIndex another sequence", py::arg("theIndex"), py::arg("theItem"));
...
void bind_NCollection_StdAllocator(py::object &mod, std::string const &name) {
	...
	// error: expected unqualified-id before ‘*’ token
	//FIXME cls.def("address", (NCollection_StdAllocator<T>::pointer (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::reference) const ) &NCollection_StdAllocator<T>::address, "Returns an object address. Returns &x.", py::arg("x"));
	//FIXME cls.def("address", (NCollection_StdAllocator<T>::const_pointer (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::const_reference) const ) &NCollection_StdAllocator<T>::address, "Returns an object address. Returns &x.", py::arg("x"));
	//FIXME cls.def("allocate", [](NCollection_StdAllocator<T> &self, NCollection_StdAllocator<T>::size_type a0) -> NCollection_StdAllocator<T>::pointer { return self.allocate(a0); }, py::arg("n"));
	//FIXME cls.def("allocate", (NCollection_StdAllocator<T>::pointer (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::size_type, const void *)) &NCollection_StdAllocator<T>::allocate, "Allocates memory for n objects. Uses underlying allocator to allocate memory.", py::arg("n"), py::arg(""));
	//FIXME cls.def("deallocate", (void (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::pointer, NCollection_StdAllocator<T>::size_type)) &NCollection_StdAllocator<T>::deallocate, "Frees previously allocated memory. Uses underlying allocator to deallocate memory.", py::arg("p"), py::arg(""));
	//FIXME cls.def("max_size", (NCollection_StdAllocator<T>::size_type (NCollection_StdAllocator<T>::*)() const ) &NCollection_StdAllocator<T>::max_size, "Returns the largest value for which method allocate might succeed.");
	//FIXME cls.def("construct", (void (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::pointer, NCollection_StdAllocator<T>::const_reference)) &NCollection_StdAllocator<T>::construct, "Constructs an object. Uses placement new operator and copy constructor to construct an object.", py::arg("p"), py::arg("val"));
	//FIXME cls.def("destroy", (void (NCollection_StdAllocator<T>::*)(NCollection_StdAllocator<T>::pointer)) &NCollection_StdAllocator<T>::destroy, "Destroys the object. Uses object destructor.", py::arg("p"));
...
void bind_NCollection_UBTree(py::object &mod, std::string const &name) {
	...
	//FIXME cls.def("Root", (const NCollection_UBTree<TheObjType, TheBndType>::TreeNode & (NCollection_UBTree<TheObjType, TheBndType>::*)() const ) &NCollection_UBTree<TheObjType, TheBndType>::Root, "Returns the root node of the tree");
...
void bind_NCollection_UBTreeFiller(py::object &mod, std::string const &name) {
	...
	//FIXME cls.def(py::init<NCollection_UBTreeFiller<TheObjType, TheBndType>::UBTree &>(), py::arg("theTree"));
	//FIXME cls.def(py::init<NCollection_UBTreeFiller<TheObjType, TheBndType>::UBTree &, const opencascade::handle<NCollection_BaseAllocator> &>(), py::arg("theTree"), py::arg("theAlloc"));
	//FIXME cls.def(py::init<NCollection_UBTreeFiller<TheObjType, TheBndType>::UBTree &, const opencascade::handle<NCollection_BaseAllocator> &, const Standard_Boolean>(), py::arg("theTree"), py::arg("theAlloc"), py::arg("isFullRandom"));
