...
// FIXME	cls.def("plus_plus", (SMDS_StdIterator<VALUE, PtrSMDSIterator, EqualVALUE>::_Self & (SMDS_StdIterator<VALUE, PtrSMDSIterator, EqualVALUE>::*)()) &SMDS_StdIterator<VALUE, PtrSMDSIterator, EqualVALUE>::operator++, py::is_operator(), "None");
// FIXME	cls.def("plus_plus", (SMDS_StdIterator<VALUE, PtrSMDSIterator, EqualVALUE>::_Self (SMDS_StdIterator<VALUE, PtrSMDSIterator, EqualVALUE>::*)(int)) &SMDS_StdIterator<VALUE, PtrSMDSIterator, EqualVALUE>::operator++, py::is_operator(), "None", py::arg(""));
